...
# Architecture
The main task of code generation is performed by [MusGen](https://github.com/ymz-ncnk/musgen). 
Which, in theory, can generate code for any language, not just Golang. MusGo, 
on the other hand, is tasked with creating the type description needed for 
[MusGen](https://github.com/ymz-ncnk/musgen), plus saving the generated code to 
the hard disk.
