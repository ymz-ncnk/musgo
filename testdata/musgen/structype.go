...
var SimpleStructTypeDesc musgen.TypeDesc = musgen.TypeDesc{
	Package: "musgen",
...
var StructTypeDesc musgen.TypeDesc = musgen.TypeDesc{
	Package: "musgen",
	Name:    "StructType",
	Fields: []musgen.FieldDesc{
		{Name: "Uint", Type: "uint"},
...
var FieldlessStructTypeDesc musgen.TypeDesc = musgen.TypeDesc{
	Package: "musgen",
