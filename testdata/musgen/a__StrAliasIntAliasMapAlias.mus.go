...
func (v StrAliasIntAliasMapAlias) Marshal(buf []byte) int {
	i := 0
	{
		length := len(v)
		{
...
func (v *StrAliasIntAliasMapAlias) Unmarshal(buf []byte) (int, error) {
	i := 0
	var err error
	{
		var length int
...
func (v StrAliasIntAliasMapAlias) Size() int {
	size := 0
	{
		length := len(v)
		{
