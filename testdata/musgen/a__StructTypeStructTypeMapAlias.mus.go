...
func (v StructTypeStructTypeMapAlias) Marshal(buf []byte) int {
	i := 0
	{
		length := len(v)
		{
...
func (v *StructTypeStructTypeMapAlias) Unmarshal(buf []byte) (int, error) {
	i := 0
	var err error
	{
		var length int
...
func (v StructTypeStructTypeMapAlias) Size() int {
	size := 0
	{
		length := len(v)
		{
