...
func generateArrayAlias(unsafe bool) error {
	...
	allTypes = append(allTypes, mgtd.FloatNilPtrArrayAliasTypeDesc)
	allTypes = append(allTypes, mgtd.Int16NilPtrArrayAliasTypeDesc)
...
func generateSliceAlias(unsafe bool) error {
	...
	allTypes = append(allTypes, mgtd.Int16NilPtrSliceAliasTypeDesc)
	...
	allTypes = append(allTypes, mgtd.IntPtrPtrPtrAliasSliceAliasTypeDesc)
